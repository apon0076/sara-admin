...
class shippingTypeListContainer extends Component {
  constructor(props) {
    super(props)
    this.state = {
      shippingTypes: null,
      selectedShippingTypes: null,
      globalFilter: null,
      loading: false,
      position: 'center',
    }
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      shippingTypes: this.props.data.sort((a, b) =>
  ...
  nameBodyTemplate(rowData) {
    return (
      <React.Fragment>
        {/* <span className="p-column-title">Shipping Type Name</span> */}
        {rowData.typeName}
      </React.Fragment>
    )
  }
        ...
        <div className='table-header'>
          <span className='p-input-icon-left'>
            <InputText
              ...
              placeholder='Search by Shipping type name'
            />
          </span>
        </div>
      </>
                    ...
                    <div className='card'>
                      ...
                      {this.props.loading ? (
                        ...
                        <DataTable
                          header={header}
                          ref={(el) => (this.dt = el)}
                          value={this.state.shippingTypes}
                          ...
                          paginator
                          rows={10}
                          emptyMessage='No Shipping Type found'
