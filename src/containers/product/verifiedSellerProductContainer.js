...
class verifiedSellerProductContainer extends Component {
  constructor(props) {
    super(props)
    this.state = {
      products: null,
  ...
  componentDidMount = async () => {
    ...
    await this.props.getSellerVerifiedProductsRecord(id)
    this.setState({
      productsData: this.props.products.sort(
...
const mapStateToProps = (state) => ({
  products: state.productReducer.verifiedSellerProducts,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    getSellerVerifiedProductsRecord: (shopId) =>
      dispatch(productAction.getSellerVerifiedProductsRecord(shopId)),
  }
}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(verifiedSellerProductContainer)
