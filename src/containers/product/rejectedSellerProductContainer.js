...
class rejectedSellerProductContainer extends Component {
  constructor(props) {
    super(props)
    this.state = {
      products: null,
  ...
  componentDidMount = async () => {
    ...
    await this.props.getSellerRejectedProductsRecord(id)
    this.setState({
    ...
    await this.props.getCommissionPercentageRecord(this.state.shops.shopId)
    this.setState({
  ...
  commissionPercent = () => {
    this.state.sellerCommission &&
      this.state.sellerCommission.map((data) =>
        this.setState({ commissionPercentage: data.localCommissionPercentage })
      )
  }
    ...
    return (
      <React.Fragment>
        <span className='p-buttonset verified-button'>
          ...
          >
            <Button label='Edit' className='p-button-info' />
          </Link>
        </span>
      </React.Fragment>
    )
                  ...
                  <div className='datatable-doc-demo datatable-responsive-demo'>
                    <div className='card'>
                      <ul className='nav nav-tabs seller-tabs'>
                        <li>
                          <Link to='/createProductSellerTest'>
                            Create Product
                          </Link>
                        </li>
                        <li>
                          <Link to='/pendingSellerProduct'>
                            Pending Product
                          </Link>
                        </li>
                        <li>
                          <Link to='/approvedSellerProduct'>
                            Approved Product
                          </Link>
                        </li>
                        <li className='active'>
                          <Link to='/rejectedSellerProduct'>
                            Rejected Product
                          </Link>
                        </li>
                      </ul>
...
const mapStateToProps = (state) => ({
  products: state.productReducer.sellerRejectedProducts,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    getSellerRejectedProductsRecord: (shopId) =>
      dispatch(productAction.getSellerRejectedProductsRecord(shopId)),
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(rejectedSellerProductContainer)
