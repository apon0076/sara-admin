...
class pendingSellerProductContainer extends Component {
  constructor(props) {
    super(props)
    this.state = {
      customers: null,
  ...
  componentDidMount = async () => {
    ...
    await this.props.getSellerPendingProductsRecord(id)

    this.setState({
      productsData: this.props.products.sort((a, b) =>
        a.timeM > b.timeM ? 1 : -1
      ),
    })
  }
...
const mapStateToProps = (state) => ({
  products: state.productReducer.pendingSellerProducts,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    getSellerPendingProductsRecord: (shopId) =>
      dispatch(productAction.getSellerPendingProductsRecord(shopId)),
  }
}
