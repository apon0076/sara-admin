...
class orderTypeListContainer extends Component {
  constructor(props) {
    super(props)
    this.state = {
      orderTypes: null,
      selectedOrderTypes: null,
      globalFilter: null,
      loading: false,
      position: 'center',
    }
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      orderTypes: this.props.data.sort((a, b) => (a.timeM > b.timeM ? 1 : -1)),
    })
  }
        ...
        <div className='table-header'>
          <span className='p-input-icon-left'>
            <InputText
              ...
              placeholder='Search by Order Type name'
            />
          </span>
        </div>
      </>
                    ...
                    <div className='card'>
                      ...
                      {this.props.loading ? (
                        ...
                        <DataTable
                          ...
                          paginator
                          rows={10}
                          emptyMessage='No Order Type found'
                        ...
                        >
                          ...
                          />
                          <Column
                            sortField='statusTypeName'
                            filterField='statusTypeName'
