...
export default function ReturnSellerOrdersListContainer() {
  ...
  const { fetchCancelOrderById, loading } = return_orders
  useEffect(() => {
    if (fetchCancelOrderById?.headers?.pagination) {
      var paginated_data_to_parse = fetchCancelOrderById.headers.pagination
  ...
  }, [fetchCancelOrderById?.headers?.pagination])
  ...
  useEffect(() => {
    if (location.location.pathname === '/ReturnSellerOrders')
                  ...
                  {loading ? (
                    ...
                    <>
                      ...
                      <Paginator
                        ...
                        itemPerPage={itemPerPage}
                        totalItems={totalItems}
                        items={fetchCancelOrderById?.data}
                        itemsPerPageOptions={[30, 60, 90, 100, 200, 300]}
                        handleItemPerPage={handleItemPerPage}
                        handleCurrentPage={handleCurrentPage}
                      />
