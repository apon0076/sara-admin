...
class warehouseAddressContainer extends Component {
  constructor(props) {
    super(props)
    this.state = {
      sellerAddressId: 0,
  ...
  handleChange = (e) => {
    ...
    switch (name) {
      ...
      case 'division':
        ...
        break
      case 'city':
        isError.city = value.length < 2 ? 'Atleast 2 characaters required' : ''
        break
      default:
        break
    }
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    getAddressByShopIdRecord: (shopId, addressTypeId) =>
      dispatch(
        sellerProfileAction.getAddressByShopIdRecord(shopId, addressTypeId)
      ),
  }
}
