...
class rejectedReturnPolicyContainer extends Component {
  constructor(props) {
    super(props)
    this.state = {
      rejectedReturn: null,
  ...
  componentDidMount = async () => {
    ...
    await this.props.getRejectedSellerReturnPolicyRecord()
    this.setState({
      rejectedReturn: this.props.rejectedReturnPolicy.sort((a, b) =>
        a.timeM > b.timeM ? 1 : -1
      ),
    })
  }
  ...
  activeReturnPolicy = async (e) => {
    ...
    const data = {
      sellerReturnPolicyId: this.state.rejectedReturn[0].sellerReturnPolicyId,
      duration: this.state.rejectedReturn[0].duration,
      returnPolicy: this.state.rejectedReturn[0].returnPolicy,
      shopId: this.state.rejectedReturn[0].shopId,
      sellerId: this.state.rejectedReturn[0].sellerId,
      isActive: 'Y',
      isApprove: this.state.rejectedReturn[0].isApprove,
    }
      ...
      <>
                    ...
                    <div className='card'>
                      ...
                      {this.props?.loading ? (
                        ...
                        <DataTable
                          header={header}
                          ref={(el) => (this.dt = el)}
                          value={this.state.rejectedReturn}
                          className='p-datatable-customers p-datatable-responsive-demo'
                          dataKey='rejectedReturnPolicyId'
                          rowHover
                          globalFilter={this.state.globalFilter}
                          paginator
                          rows={10}
                          emptyMessage='No Rejected Return Policy Found!'
          ...
          <div className='modal-dialog modal-confirm'>
            <div className='modal-content'>
              <div className='modal-header flex-column'>
                <h4 className='modal-title w-75'>Active Return Policy</h4>
                <button
                  type='button'
                  className='close'
                  data-dismiss='modal'
        ...
        <div id='inactivateModal' className='modal fade'>
          <div className='modal-dialog modal-confirm'>
            <div className='modal-content'>
              <div className='modal-header flex-column'>
                <h4 className='modal-title w-75'>Inactive Return Policy</h4>
                <button
                  type='button'
                  className='close'
                  data-dismiss='modal'
...
const mapStateToProps = (state) => ({
  rejectedReturnPolicy: state.sellerReducer.rejectedReturnPolicy,
...
const mapDispatchToProps = (dispatch) => {
  return {
    getRejectedSellerReturnPolicyRecord: () =>
      dispatch(sellerAction.getRejectedSellerReturnPolicyRecord()),
