...
class editInventoryContainer extends Component {
  ...
  componentDidMount = async () => {
    await this.props.getProductByIdRecord(this.props.match.params.id);
    await this.props.getColorByIdRecord(this.props.match.params.id);
    await this.props.getSizeByIdRecord(this.props.match.params.id);
    await this.props.getInventoryByIdRecord(this.props.match.params.id);
  };
  ...
  saveInventory = async (e) => {
    ...
    await this.props.createInventoryRecord(data);
    this.clearData(e);
  };
...
const mapDispatchToProps = (dispatch) => {
  return {
    getProductByIdRecord: (index) =>
      dispatch(productAction.getProductByIdRecord(index)),
