...
const EditBlogPost = (props) => {
  ...
  useEffect(() => {
    props.postDescription && setBlogDescription(props.postDescription);
                          ...
                          <div className="form-group">
                            ...
                            <div className="dropdown-demo">
                              <Dropdown
                                ...
                                placeholder={props.blogCategoryName}
                                name="selectedPostCategoryId"
                                value={props.selectedPostCategoryId}
