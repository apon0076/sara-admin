...
export default function EditFreeShippingProductCategory(props) {
  ...
  const updateShippingCostFreeShippingProductCategory = async (e) => {
    e.preventDefault()
              ...
              <div className='text-center'>
                <div className='btn-group text-center'>
                  <button
                    ...
                    onClick={updateShippingCostFreeShippingProductCategory}
                  >
                    Update
                  </button>
                </div>
