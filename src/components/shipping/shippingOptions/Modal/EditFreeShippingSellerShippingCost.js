...
export default function EditFreeShippingSellerShippingCost(props) {
  ...
  const updateShippingCostFreeShippingSellerShippingCost = async (e) => {
    e.preventDefault()
              ...
              <div className='text-center'>
                <div className='btn-group text-center'>
                  <button
                    ...
                    onClick={updateShippingCostFreeShippingSellerShippingCost}
                  >
                    Update
                  </button>
                </div>
