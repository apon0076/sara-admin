...
export default function EditFlatRateSellerShippingCost(props) {
  ...
  const updateShippingCostFlatRateSellerShippingCost = async (e) => {
    e.preventDefault()
              ...
              <div className='text-center'>
                <div className='btn-group text-center'>
                  <button
                    ...
                    onClick={updateShippingCostFlatRateSellerShippingCost}
                  >
                    Update
                  </button>
                </div>
