...
export default function EditFlatRateFixedRate(props) {
  ...
  const handleChange = (e) => {
    ...
    switch (target.name) {
      ...
      case 'customDutiesChargePer':
        ...
        setActualCost(
          parseFloat((rateCharge * target.value) / 100) +
  ...
  const updateFlatRateFixedRate = async (e) => {
    e.preventDefault()
              ...
              <div className='text-center'>
                <div className='btn-group text-center'>
                  <button
                    ...
                    onClick={updateFlatRateFixedRate}
                  >
                    Update
                  </button>
                </div>
