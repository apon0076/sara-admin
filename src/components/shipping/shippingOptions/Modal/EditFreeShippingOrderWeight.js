...
export default function EditFreeShippingOrderWeight(props) {
  ...
  const updateShippingCostFreeShippingOrderWeight = async (e) => {
    e.preventDefault()
    ...
    if (shippingTotalCost === '') {
      let msg = 'Shipping TCost Is Required!!!'
      toast.error(msg)
      setTimeout(() => {}, 3000)
      return
    }
              ...
              <div className='text-center'>
                <div className='btn-group text-center'>
                  <button
                    ...
                    onClick={updateShippingCostFreeShippingOrderWeight}
                  >
                    Update
                  </button>
                </div>
