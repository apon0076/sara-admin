...
export default function EditFlatRateProductCategory(props) {
  ...
  const updateShippingCostFlateRateProductCategory = async (e) => {
    e.preventDefault()
              ...
              <div className='text-center'>
                <div className='btn-group text-center'>
                  <button
                    ...
                    onClick={updateShippingCostFlateRateProductCategory}
                  >
                    Update
                  </button>
                </div>
