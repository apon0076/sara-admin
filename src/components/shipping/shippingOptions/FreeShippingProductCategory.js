...
const FreeShippingProductCategory = (props) => {
  ...
  const saveShippingCostFreeShippingProductCategory = async (e) => {
    e.preventDefault()
                  ...
                  <div className='text-center'>
                    <div className='btn-group text-center'>
                      <button
                        ...
                        onClick={saveShippingCostFreeShippingProductCategory}
                      >
                        Create
                      </button>
                      <Link to='/Home'>
...
export default FreeShippingProductCategory
