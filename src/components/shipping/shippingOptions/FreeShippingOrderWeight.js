...
const FreeShippingOrderWeight = (props) => {
  ...
  const createShippingCostFreeShippingOrderWeight = async (e) => {
    e.preventDefault()
                  ...
                  <div className='text-center'>
                    <div className='btn-group text-center'>
                      <button
                        ...
                        onClick={createShippingCostFreeShippingOrderWeight}
                      >
                        Create
                      </button>
                      <Link to='/Home'>
...
export default FreeShippingOrderWeight
