...
const FlatRateFixedRate = (props) => {
  ...
  const createShippingCostFlateRateFixedRate = async (e) => {
    e.preventDefault()
                  ...
                  <div className='text-center'>
                    <div className='btn-group text-center'>
                      <button
                        ...
                        onClick={createShippingCostFlateRateFixedRate}
                      >
                        Create
                      </button>
                      <Link to='/Home'>
...
export default FlatRateFixedRate
