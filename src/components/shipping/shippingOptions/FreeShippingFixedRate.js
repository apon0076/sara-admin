...
const FreeShippingFixedRate = (props) => {
  ...
  const createShippingCostFreeShippingFixedRate = async (e) => {
    e.preventDefault()
    ...
    <div
      ...
      style={{
        display:
          ...
          shippingCostData.fixedRateSelected === false
            ? 'none'
                  ...
                  <div className='text-center'>
                    <div className='btn-group text-center'>
                      <button
                        ...
                        onClick={createShippingCostFreeShippingFixedRate}
                      >
                        Create
                      </button>
                      <Link to='/Home'>
...
export default FreeShippingFixedRate
