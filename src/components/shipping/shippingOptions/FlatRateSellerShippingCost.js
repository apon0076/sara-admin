...
const FlatRateSellerShippingCost = (props) => {
  ...
  const saveShippingCostFlatRateSellerShippingCost = async (e) => {
    e.preventDefault()
                  ...
                  <div className='text-center'>
                    <div className='btn-group text-center'>
                      <button
                        ...
                        onClick={saveShippingCostFlatRateSellerShippingCost}
                      >
                        Create
                      </button>
                      <Link to='/Home'>
...
export default FlatRateSellerShippingCost
