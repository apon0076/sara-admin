...
const FreeShippingOrderQty = (props) => {
    ...
    <div
      ...
      style={{
        display:
          ...
          shippingCostData.orderQtySelected === false
            ? 'none'
                  ...
                  <div className='text-center'>
                    <div className='btn-group text-center'>
                      <button
                        ...
                        onClick={shippingCostData.saveShippingCostOrderQty}
                      >
                        Create
                      </button>
                      <Link to='/Home'>
...
export default FreeShippingOrderQty
