...
export default function ManageStatus(props) {
  ...
  const { orderProfileId, orderNo, shopWiseOrderId, statusId, statusName } =
    props.orders
  ...
  setValue(
    'defaultOrderStatus',
    defaultOrderStatus & defaultOrderStatus ? defaultOrderStatus : ''
  )
  ...
  const createOrderTracking = async (data, e) => {
    ...
    let orderTrackingData = {
      ...
      isActive: 'Y',
      trackingRefNo: data.trackingRefNo,
    }
  ...
  const handleMoreOption = (e) => {
    setMoreOption(e.target.checked)
  }
          ...
          <div className='modal-content'>
            <div id='divToPrint'>
              <div className='modal-header'>
                ...
                >
                  <div>
                    <h6 className='modal-title' id='exampleModalLongTitle'></h6>
                  </div>
                </div>
              </div>
                  ...
                  >
                        ...
                        <div className='form-group'>
                          <div className='checkbox checkbox-success'>
                            ...
                            <input
                              ...
                              name='moreOption'
                              checked={moreOption}
                              onChange={handleMoreOption}
                            />
                            <label htmlFor='moreOption'> &nbsp;Show More Options</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    {moreOption && (
                      <>
                        ...
                        <Row>
                          <Col xs={12} md={12}>
                            <Form.Group controlId='trackingRefNo'>
                              <Form.Label>Tracking Reference No.</Form.Label>
                              <Form.Control
                                type='text'
                                ...
                                value={trackingRefNo}
                                onChange={(e) =>
                                  setTrackingRefNo(e.target.value)
                                }
                                className='form-control'
                                ref={register}
                                autoComplete='off'
                                style={{ height: '40px', borderRadius: '4px' }}
                              />
                              {errors.trackingRefNo && (
                                <span className='error'>
                                  {errors.trackingRefNo.message}
                                </span>
                              )}
                            </Form.Group>
                          </Col>
