...
const CreateDiscountSummary = (props) => {
  return (
                          ...
                          <div className='form-group'>
                            ...
                            <div className='dropdown-demo'>
                              <Dropdown
                                ...
                                options={props.discountTypes.filter(
                                ...
                                {props.image === '' ? (
                                  <div className='file-dummy'>
                                    <div className='default'>
                                      Upload Discount Summary Image
                                    </div>
                                  </div>
                                ) : (
                                  <div className='file-dummy'>
                                    <div className='success'>
                                      Discount Summary Image Uploaded
                                      Successfully
                                    </div>
                                  </div>
                                )}
...
export default CreateDiscountSummary
