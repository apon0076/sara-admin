...
export default function SellerInvoiceAdminAllDisplay(props) {
      ...
      >
        <div className="seller_invoice_barcode__section">
          ...
          {/* <div className="barcode_section">
            <Barcode value={invoiceInfo?.packageNo} />
            {invoiceInfo?.packageNo ? (
              <p className="barcode_title">
                Package Id: {invoiceInfo?.packageNo}
              </p>
            ) : null}
          </div> */}
            ...
            <table>
              ...
              <tr>
                ...
                <td className="invoice_total__row">
                  {props.currencyFormat(invoiceInfo?.totalPayableAmt)}
                </td>
              </tr>
            </table>
          </div>
