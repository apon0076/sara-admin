...
export default function SellerInvoiceAdminDisplay(props) {
  const invoiceInfo = props?.invoice
  let totalPrice = 0

  for (var i = 0; i < invoiceInfo?.orderDetails?.length; i++) {
    totalPrice =
      totalPrice +
      invoiceInfo?.orderDetails[i]?.productPrice *
        invoiceInfo?.orderDetails[i]?.productQuantity
  }
    ...
    <div className='seller_invoice_container' style={{ marginBottom: '100vh' }}>
        ...
        <div className='seller_invoice_barcode__section'>
          <div className='seller_invoice_logo__section'>
            <div className='seller_invoice_logo__date_section'>
              ...
              <p>Date: {invoiceInfo?.createDate?.slice(0, 10)}</p>
          ...
          <div className='package_information__section'>
            ...
            <p>
              Total Amount: <br /> <b>{props.currencyFormat(invoiceInfo?.totalPayableAmt)}</b>{' '}
              {invoiceInfo?.orderDetails[0]?.baseCurrency}
            </p>
            {/* <p>
      ...
      >
        <div className='seller_invoice_purchase_history__header'>
          ...
          <div className='seller_invoice_purchase_history__header_info'>
            <p>
              <b>Date:</b> {invoiceInfo?.createDate?.slice(0, 10)}
            </p>
            <p>
              <b>Payment Method:</b>{' '}
              {invoiceInfo?.paymentMethodName
            ...
            <table>
              <tr>
                ...
                <td className='invoice__total_col'>
                  ...
                  {props.currencyFormat(invoiceInfo?.grossSubTotal)}
                </td>
              </tr>
              <tr>
                <td className='invoice__total_col'>Discount/Voucher:</td>
                <td className='invoice__total_col'>
                  {props.currencyFormat(invoiceInfo?.voucherAmount !==0 ? invoiceInfo?.voucherAmount : invoiceInfo?.totalDiscountFlatAmt)}
                </td>
              </tr>
              <tr>
                ...
                <td className='invoice__total_col'>
                  {/* {parseFloat(totalPrice || 0).toFixed(2)}{' '} */}
                  {props.currencyFormat(invoiceInfo?.netAmount)}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td className='invoice__total_col'>Shipping Cost:</td>
                <td className='invoice__total_col'>
