...
var DayTableMixin = FC.DayTableMixin = {
	...
	renderHeadHtml: function() {
		...
		return '' +
			'<div className="fc-row ' + view.widgetHeaderClass + '">' +
				'<table>' +
					'<thead>' +
...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	renderNumberCellHtml: function(date) {
		...
		html += '<td className="' + classes.join(' ') + '"' +
			(isDateValid ?
...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		if (seg.isStart) {
			...
			if (timeText) {
				timeHtml = '<span className="fc-time">' + htmlEscape(timeText) + '</span>';
			}
		}
...
var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin, {
	...
	renderNowIndicator: function(date) {
		...
		for (i = 0; i < segs.length; i++) {
			nodes.push($('<div className="fc-now-indicator fc-now-indicator-line"></div>')
				.css('top', top)
		...
		if (segs.length > 0) { // is the current time in view?
			nodes.push($('<div className="fc-now-indicator fc-now-indicator-arrow"></div>')
				.css('top', top)
...
function Toolbar(calendar, toolbarOptions) {
	...
	function render() {
		...
		if (sections) {
			if (!el) {
				el = this.el = $("<div className='fc-toolbar "+ toolbarOptions.extraClasses + "'/>");
			}
			else {
				el.empty();
			}
					...
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							if (overrideText) {
								...
								innerHtml = "<span className='ui-icon ui-icon-" + themeIcon + "'></span>";
							}
							else if (normalIcon && !calendar.opt('theme')) {
								innerHtml = "<span className='fc-icon fc-icon-" + normalIcon + "'></span>";
							}
							else {
...
Calendar.mixin({
	...
	initialRender: function() {
		...
		this.contentEl = $("<div className='fc-view-container'/>").prependTo(el);
	...
	renderView: function(viewType, forcedScroll) {
		...
		if (!this.view && viewType) {
			...
			this.view.setElement(
				$("<div className='fc-view fc-" + viewType + "-view' />").appendTo(this.contentEl)
			);
...
var BasicView = FC.BasicView = View.extend({
	...
	renderDates: function() {
		...
		var dayGridEl = $('<div className="fc-day-grid" />').appendTo(dayGridContainerEl);
		...
		return '' +
			'<table>' +
				'<thead className="fc-head">' +
					'<tr>' +
						'<td className="fc-head-container ' + this.widgetHeaderClass + '"></td>' +
					'</tr>' +
				'</thead>' +
				'<tbody className="fc-body">' +
					'<tr>' +
						'<td className="' + this.widgetContentClass + '"></td>' +
					'</tr>' +
				'</tbody>' +
			'</table>';
	},
...
var basicDayGridMethods = {
	...
	renderHeadIntroHtml: function() {
		...
		if (view.colWeekNumbersVisible) {
			return '' +
				'<th className="fc-week-number ' + view.widgetHeaderClass + '" ' + view.weekNumberStyleAttr() + '>' +
	...
	renderNumberIntroHtml: function(row) {
		...
		if (view.colWeekNumbersVisible) {
			return '' +
				'<td className="fc-week-number" ' + view.weekNumberStyleAttr() + '>' +
	...
	renderBgIntroHtml: function() {
		...
		if (view.colWeekNumbersVisible) {
			return '<td className="fc-week-number ' + view.widgetContentClass + '" ' +
	...
	renderIntroHtml: function() {
		...
		if (view.colWeekNumbersVisible) {
			return '<td className="fc-week-number" ' + view.weekNumberStyleAttr() + '></td>';
		}
...
var AgendaView = FC.AgendaView = View.extend({
	...
	renderDates: function() {
		...
		var timeGridEl = $('<div className="fc-time-grid" />').appendTo(timeGridWrapEl);
		...
		this.bottomRuleEl = $('<hr className="fc-divider ' + this.widgetHeaderClass + '"/>')
...
var agendaTimeGridMethods = {
	...
	renderHeadIntroHtml: function() {
		...
		if (view.opt('weekNumbers')) {
			...
			return '' +
				'<th className="fc-axis fc-week-number ' + view.widgetHeaderClass + '" ' + view.axisStyleAttr() + '>' +
					view.buildGotoAnchorHtml( // aside from link, important for matchCellWidths
			...
			return '<th className="fc-axis ' + view.widgetHeaderClass + '" ' + view.axisStyleAttr() + '></th>';
		}
	},
	...
	renderBgIntroHtml: function() {
		...
		return '<td className="fc-axis ' + view.widgetContentClass + '" ' + view.axisStyleAttr() + '></td>';
	},
...
var agendaDayGridMethods = {
	...
	renderBgIntroHtml: function() {
		...
		return '' +
			'<td className="fc-axis ' + view.widgetContentClass + '" ' + view.axisStyleAttr() + '>' +
				'<span>' + // needed for matchCellWidths
					view.getAllDayHtml() +
				'</span>' +
			'</td>';
...
var ListViewGrid = Grid.extend({
	...
	renderSegList: function(allSegs) {
		...
		var daySegs;
		var i;
		var tableEl = $('<table className="fc-list-table"><tbody/></table>');
	...
	dayHeaderHtml: function(dayDate) {
		...
		return '<tr className="fc-list-heading" data-date="' + dayDate.format('YYYY-MM-DD') + '">' +
			'<td className="' + view.widgetHeaderClass + '" colspan="3">' +
				(mainFormat ?
					view.buildGotoAnchorHtml(
						dayDate,
	...
	fgSegHtml: function(seg) {
		...
		return '<tr className="' + classes.join(' ') + '">' +
			(this.displayEventTime ?
				'<td className="fc-list-item-time ' + view.widgetContentClass + '">' +
					(timeHtml || '') +
				'</td>' :
				'') +
			'<td className="fc-list-item-marker ' + view.widgetContentClass + '">' +
				...
				'></span>' +
			'</td>' +
			'<td className="fc-list-item-title ' + view.widgetContentClass + '">' +
